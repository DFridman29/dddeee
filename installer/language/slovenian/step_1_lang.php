...
$lang['httpserver_text']=	'FatCMS potrebuje za prikaz dinamičnih vsebin obiskovalcem vaše spletne strani HTTP strežnik. Glede na to da vidite trenutno stran, imate takšen strežnik že nameščen, če pa veste kakšnega, potem bo FatCMS znal izbrati strežniku bolj primerne nastavitve. V primeru, da ne veste kaj izbrati v spodnjem obrazcu, lahko izbiro preskočite in nadaljujete na naslednji korak.';
...
$lang['mod_rewrite']	=	'Izbrali ste "(Apache z mod_rewrite)" vendar pa ga vaš strežnik nima omogočenega.Vprašajte vašega gostitelja če ga lahko omogoči ali pa namesite FatCMS z uporabo "Apache (brez mod_rewrite)" opcije.';
$lang['step2']			=	'Korak 2';
