...
$lang['httpserver_text']=	'FatCMS requer um servidor HTTP para exibir conteúdo dinâmico quando um usuário visita seu website. Parece que você já tem um pelo fato de que você pode ver esta página, mas se você souber qual o tipo, FatCMS pode então se configurar melhor ainda. Se você não souber o que isto significa então ignore e continue com a instalação.';
...
$lang['mod_rewrite']	=	'Vcoê selecionou "(Apache with mod_rewrite)", mas seu servidor não possui o módulo de reescrita "mod_rewrite" habilitado. Peça ao responsável de sua hospedagem para habilitar isso ou instale o FatCMS usando a opção "Apache (without mod_rewrite)".';
$lang['step2']			=	'2ª Etapa';
