...
$lang['server_fail']	=	'您的伺服器軟體我們沒有支援，因此 FatCMS 可能無法運作。只要您安裝的 PHP 與 MySQL 是最新的版本，PyroCMS 應該都可以正常運作。';

$lang['php_settings']	=	'PHP 設定';
$lang['php_required']	=	'FatCMS 需要 PHP %s 或更新的版本。';
$lang['php_version']	=	'您伺服器目前的版本';
$lang['php_fail']		=	'您的 PHP 版本我們並沒有支援。PyroCMS 需要 PHP 版本 %s 或是更新的版本，才能夠正常運作。';

$lang['mysql_settings']	=	'MySQL 設定';
$lang['mysql_required']	=	'FatCMS 需要存取 MySQL 資料庫版本 5.0 或更新的版本。';
...
$lang['gd_required']	= 	'FatCMS 需要 GD 程式庫 1.0 或更新的版本，用做圖片的處理。';
...
$lang['zlib']			=	'Zlib';
$lang['zlib_required']	= 	'FatCMS 需要 Zlib 才能對網站佈景主題(theme)進行解壓縮與安裝。';
$lang['zlib_fail']		=	'找不到 Zlib 程式庫。這通常表示此程式庫尚未安裝。PyroCMS 將仍然可以運作，但是安裝佈景主題的相關功能就無法作用了。因此，我們強烈建議您先安裝並啟動 Zlib 程式庫。';

$lang['curl']			=	'Curl';
$lang['curl_required']	=	'FatCMS 需要 Curl 才能和其他網站建立連結。';
$lang['curl_fail']		=	'找不到 Curl 程式庫。這通常表示此程式庫尚未安裝。PyroCMS 將仍然可以運作，但是有些功能可能無法使用。因此，我們強烈建議您先安裝並啟動 Curl 程式庫。';

$lang['summary_success']	=	'您的伺服器符合正確執行 FatCMS 的所有需求，請點選下方的按鈕進行下一步。';
$lang['summary_partial']	=	'您的伺服器符合 FatCMS 的<em>大部分</em>需求，這表示 FatCMS 將仍然可以運作，但是某些情況下會遇到問題，例如：在建立縮圖的尺寸縮放時。';
$lang['summary_failure']	=	'看來似乎您的伺服器不符合執行 FatCMS 的需求。請聯繫您的伺服器管理員或是網站空間的服務提供商，請他們協助解決。';
