...
$lang['intro_text']		=	'Cài đặt FatCMS rất dễ dàng và chỉ mất vài phút. Trong trường hợp không hiểu rõ về các câu hỏi của hệ thống, bạn có thể nhờ sự trợ giúp của nhà cung cấp dịch vụ lưu trữ web hoặc <a href="http://pyrocms.com/contact" target="_blank">liên hệ với chúng tôi</a>.';

$lang['db_settings']	=	'Thiết lập cơ sở dữ liệu';
$lang['db_text']		=	'FatCMS yêu cầu một cơ sở dư liệu (MySQL) để lưu các thiết lập và nội dung website của bạn, do vậy điều đầu tiên là kiểm tra kết nối đến cơ sở dữ liệu hoạt động tốt. Hãy yêu cầu nhà cung cấp hoặc quản trị viên hỗ trợ trong trường hợp bạn không trả lời được các câu hỏi của hệ thống';
...
$lang['httpserver_text']=	'FatCMS cần có một HTTP Server để hiển thị nội dung website. Nếu biết chính xác loại HTTP Server, FatCMS có thể tự cấu hình tốt hơn. Nếu bạn không rõ, có thể bỏ qua và tiếp tục quá trình cài đặt.';
