...
$lang['httpserver_text']=	'Το FatCMS χρειάζεται έναν διακομιστή HTTP για να προβάλλει δυναμικό περιεχόμενο όταν κάποιος επισκέπτεται τον ιστότοπό σας. Εφόσον μπορείτε να βλέπετε αυτήν την σελίδα είναι προφανές ότι έχετε ένα τέτοιο διακομιστή. Το FatCMS γνωρίζοντας τον ακριβή τύπο του διακομιστή HTTP μπορεί να ρυθμίσει τον εαυτό του καλύτερα. Αν δεν καταλαβάνετε τι σημαίνουν όλα αυτά, απλώς αγνοήστε τα και συνεχίστε την εγκατάσταση.';
...
$lang['mod_rewrite']	=	'Έχετε επιλέξει "(Apache with mod_rewrite)" αλλά ο διακομιστής σας δεν έχει το mod_rewrite ενεργοποιημένο. Ζητήστε από τον host σας να το ενεργοποιήσει ή εγκαταστήστε το FatCMS χρησιμοποιώντας την επιλογή "Apache (without mod_rewrite)".';
$lang['step2']			=	'Βήμα 2';
