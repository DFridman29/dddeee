...
$lang['summary_green']	=	'您的伺服器符合正確執行 FatCMS 的所有需求，請點選下方的按鈕進行下一步。';
$lang['summary_orange']	=	'您的伺服器符合 FatCMS 的<em>大部分</em>需求，這表示 FatCMS 將仍然可以運作，但是某些情況下會遇到問題，例如：在建立縮圖的尺寸縮放時。';
$lang['summary_red']	=	'看來似乎您的伺服器不符合執行 FatCMS 的需求。請聯繫您的伺服器管理員或是網站空間的服務提供商，請他們協助解決。';
