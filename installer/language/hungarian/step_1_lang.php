...
$lang['intro_text']              = 'A FatCMS-t nagyon egyszerű telepíteni és csak pár percet vesz igénybe, de az itt feltett kérdések zavarba ejtőek lehetnek, ha nem rendelkezel megfelelő technikai tudásháttérrel. Ha valamelyik pontnál megakadnál, akkor kérdezd meg a tárhelyszolgáltatódat vagy <a href="/contact" target="_blank">minket</a>, hogy segíthessünk!';

$lang['db_settings']             = 'Adatbázis beállítások';
$lang['db_text']                 = 'FatCMS-hez szükség van egy adatbázisra (MySQL), ami tárolja az összes tartalmat és beállítást. Tehát elsőként ezt kell ellenőriznünk, hogy minden adatbázis beállitás rendben van-e. Ha nem tudod, hogy mit kell megadni, akkor kérd el az adatokat a tárhelyszolgáltatódtól vagy a szerver adminisztrátorától!';
...
$lang['httpserver_text']         = 'FatCMS-nek HTTP szerverre van szüksége, hogy az oldal tartalma megjelenjen a látogatóknak. Úgy néz ki, hogy rendelkezel vele, mert látod ezt az oldalt, de azt is tundunk kell mi a típusa, hogy a FatCMS még jobb legyen. Ha nem tudod, hogy ez mit jelent, akkor hagyd figyelmen kívül és folytasd a telepítést!';
