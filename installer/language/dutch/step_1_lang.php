...
$lang['httpserver_text']=	'FatCMS heeft een HTTP Server nodig om dynamische content te weergeven wanneer een bezoeker op uw website komt. Het ziet er naar uit dat u dit al heeft omdat u deze pagina kunt zien. Als u precies weet welk type u heeft kunt u FatCMS nog beter configureren. Anders kunt u verder gaan met de installatie.';
...
$lang['mod_rewrite']	=	'U heeft Apache (met mod_rewrite) geselecteerd, maar uw HTTP-Server heeft mod_rewrite niet inschakeld.Vraag uw beheerder om dit in te schakelen, of installeer FatCMS met de optie "Apache (zonder mod_rewrite)".';
$lang['step2']			=	'Stap 2';
