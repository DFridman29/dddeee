...
$lang['httpserver_text']=	'يتطلب FatCMS خادم HTTP لعرض المُحتوى الديناميكي عند دخول الزوار إلى موقعك. ولا بد أن الخادم موجود لكن كي يستطيع FatCMS تهيئة نفسه بشكل أفضل، يجب أن يعرف ماهية هذا الخادم. إن لم تعرف ما الذي نتكلم عنه فلا تكترث وفقط استمر في عملية التثبيت.';
...
$lang['mod_rewrite']	=	'اخترت "(أباتشي مع mod_rewrite)" إلا أن هذه الوحدة غير مفعّلة. رجاءً اطلب من مضيف الخادم تفعيلها أو قم بتثبيت FatCMS باستخدام خيار "أباتشي (بدون mod_rewrite)".';
