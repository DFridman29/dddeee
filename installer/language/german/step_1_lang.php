...
$lang['db_text']            = 'Um die Version der mySQL-Datenbank zu &uuml;berpr&uuml;ffen, geben Sie bitte im nachfolgenden Formular den Hostnamen, den Benutzernamen und das Passwort des MySQL-Servers an. Diese Einstellungen werden ebenfalls zur Installation vom FatCMS ben&ouml;tigt.';
...
$lang['httpserver_text']    = 'Das FatCMS ben&ouml;tigt einen funktionsf&auml;higen HTTP-Server, um die Daten dynamisch auf Ihrer Webseite darstellen zu k&ouml;nnen. Da du diese Seite hier sehen kannst, scheint es, als w&uuml;rde bereits ein funktionierender HTTP-Server auf laufen. Wenn Sie jedoch wissen welchen HTTP-Server Sie nutzen, geben Sie diesen bitte an. FatCMS kann sich so besser konfigurieren. Wenn Sie sich nicht sicher sind, ignorieren sie diese Angabe und f&uuml;hren Sie die Installation fort.';
