...
$lang['intro_text']			= 'Заполните форму ниже и нажмите кнопку "Установить", для установки FatCMS. Убедитесь, что устанавливаете FatCMS в правильную базу данных - все имеющиеся данные в этой базе данных будут удалены!'; #translate
...
$lang['success']				= 'FatCMS успешно установлена.';