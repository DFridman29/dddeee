...
$lang['httpserver_text']=	'FatCMS memerlukan HTTP Server untuk menampilkan konten dinamik ketika pengguna membuka situs Anda. Ini nampak seperti Anda sudah memiliki suatu halaman yang dapat Anda lihat, tapi bila kita ketahui dengan tepat jenis yang mana maka FatCMS dapat mengatur sendiri dengan lebih baik. Apabila Anda tidak mengerti apa maksudnya iniabaikan saja dan lanjutkan instalasi.';
...
$lang['mod_rewrite']	=	'Anda telah memilih "(Apache dengan mod_rewrite)" tetapi server Anda tidak memiliki modul rewrite yang menyala. Minta pada host Anda untuk menyalakanya atau install FatCMS dengan opsi "Apache (tanpa mod_rewrite)".';
