...
$lang['intro_text']		=	'FatCMS is very easy to install and should only take a few minutes, but there are a few questions that may appear confusing if you do not have a technical background. If at any point you get stuck please ask your web hosting provider or email DFridman29@gmail.com for support.';

$lang['db_settings']	=	'Database Settings';
$lang['db_text']		=	'FatCMS requires a database (MySQL) to store all of your content and settings, so the first thing we will do is establish a connection to an existing database or create a new one if the box below is checked. If you do not understand what you are being asked to enter please ask your web hosting provider or server administrator for the details. <br><br>If you type the name of an existing database its data will be overwritten!';
...
$lang['httpserver_text']=	'FatCMS requires a HTTP Server to display dynamic content when a user goes to your website. It looks like you already have one by the fact that you can see this page, but if we know exactly which type then FatCMS can configure itself even better. If you do not know what any of this means just ignore it and carry on with the installation.';
...
$lang['mod_rewrite']	=	'You have selected "(Apache with mod_rewrite)" but your server does not have the rewrite module enabled. Ask your host to enable it or install FatCMS using the "Apache (without mod_rewrite)" option.';
$lang['step2']			=	'Step 2';
