...
$lang['httpserver_text']=	'FatCMS requires a HTTP Server to display dynamic content when a user goes to your website. It looks like you already have one by the fact that you can see this page, but if know exactly which type then FatCMS can configure itself even better. If you do not know what any of this means just ignore it and carry on with the installation.'; #translate
$lang['rewrite_fail']	=	'Du har valgt "(Apache with mod_rewrite)", men vi kan ikke se om mod_rewrite er aktiveret. Spørg din host om mod_rewrite er installeret eller installer FatCMS på egen risiko.';
$lang['mod_rewrite']	=	'Du har valgt "(Apache with mod_rewrite)", men vi kan ikke se om mod_rewrite er aktiveret. Spørg din host om mod_rewrite er installeret eller installer FatCMS på egen risiko.';
$lang['step2']			=	'Trin 2';
