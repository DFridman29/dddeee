...
$lang['httpserver_text']=	'O FatCMS requer um servidor HTTP para exibir conteúdo dinâmico quando um utilizador visita o seu site. Parece que já tem um pelo fato de que você está a ver esta página, mas se sabe exatamente o tipo, então o FatCMS pode configurar-se ainda melhor. Se não sabe o que nada disto significa simplesmente pode ignorar e continuar com a instalação.';
...
$lang['mod_rewrite']	=	'Selecionou "(Apache with mod_rewrite)", mas o seu servidor não possui o módulo de reescrita "mod_rewrite" habilitado. Peça ao responsável  do seu serviço de hosting para habilitar isso ou instale o FatCMS usando a opção "Apache (without mod_rewrite)".';
$lang['step2']			=	'2ª Etapa';
