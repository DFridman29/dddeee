 ...
 * 
 * @package 	FatCMS\Core\Controllers
...
class MY_Controller extends MX_Controller
{
	...
	public function __construct()
	{
		...
		// Migration logic helps to make sure FatCMS is running the latest changes
		...
		{
			log_message('debug', 'FatCMS was migrated to version: ' . $schema_version);
		}
